public Plugin_init_obj_remover()
{
...
public plugin_precache_obj_remover()
{
	// Initialize arrays
...
// Emit Sound Forward
public fw_EmitSound_objectives(id, channel, const sample[], Float:volume, Float:attn, flags, pitch)
{
	// Block all those unneeeded hostage sounds
